...
create_constraint_mode -name func_mode \
    -sdc_files {../synthesis/outputs/sram_64b_w16.sdc}

create_analysis_view -name WC_view \
    -constraint_mode func_mode -delay_corner WC_corner
create_analysis_view -name BC_view \
    -constraint_mode func_mode -delay_corner BC_corner
create_analysis_view -name TC_view \
    -constraint_mode func_mode -delay_corner TC_corner
