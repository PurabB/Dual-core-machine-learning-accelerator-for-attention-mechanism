...
assign out = $signed(product0) + $signed(product1) + $signed(product2) + $signed(product3) + 
             $signed(product4) + $signed(product5) + $signed(product6) + $signed(product7);
